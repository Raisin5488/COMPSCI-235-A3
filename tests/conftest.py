...
TEST_DATA_PATH_MEMORY = os.path.join('C:', os.sep, 'Users', 'yiwei', 'PycharmProjects', 'COMPSCI-235-A2', 'tests', 'data', 'memory')
TEST_DATA_PATH_DATABASE = os.path.join('C:', os.sep, 'Users', 'yiwei', 'PycharmProjects', 'COMPSCI-235-A2', 'tests', 'data', 'database')


TEST_DATABASE_URI_IN_MEMORY = 'sqlite://'
TEST_DATABASE_URI_FILE = 'sqlite:///movie-web.db'
